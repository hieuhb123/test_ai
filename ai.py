...
while run:
    ...
    if ((0 < blinky_x + 22 - (player_x + 23) < 73) and abs(blinky_y - player_y) < 30) \
        or ((0 < pinky_x + 22 - (player_x + 23) < 73) and abs(pinky_y - player_y) < 30) \
        or ((0 < inky_x + 22 - (player_x + 23) < 73 ) and abs(inky_y - player_y) < 30) \
        or  ((0 < clyde_x + 22 - (player_x + 23) < 73) and abs(clyde_y  - player_y ) < 30):
        ghost_right = 1
    if ( ( 0 < (player_x + 23) - (blinky_x + 22) < 73)  and abs(blinky_y - player_y) < 30)\
        or ((0 < (player_x + 23) - (pinky_x + 22) < 73) and abs(pinky_y - player_y) < 30 )\
        or (( 0 < (player_x + 23) - (inky_x + 22) < 73 ) and abs(inky_y - player_y) < 30 )\
        or  ((0 < (player_x + 23) - (clyde_x + 22) < 73) and abs(clyde_y  - player_y ) < 30) :
        ghost_left = 1
    if ((0 < (player_y + 24) - (blinky_y + 22) < 73) and  abs(player_x - blinky_x) < 30 )\
        or (( 0 < (player_y + 24) - (pinky_y + 22) < 73) and  abs(player_x - pinky_x) < 30 ) \
        or ((0 < (player_y + 24) - (inky_y + 22) < 73 ) and abs(player_x - inky_x) < 30)\
        or  (0 < ((player_y + 24) - (clyde_y + 22) < 73) and abs(player_x - clyde_x) < 30):
        ghost_up = 1
    if ((0 < blinky_y + 22 - (player_y + 24) < 73) and abs(player_x - blinky_x) < 30 ) \
        or ((0 < pinky_y + 22 - (player_y + 24) < 73) and  abs(player_x - pinky_x) < 30)  \
        or ((0 < inky_y + 22 - (player_y + 24) < 73 ) and  abs(player_x - inky_x) < 30) \
        or  ((0 < clyde_y + 22 - (player_y + 24) < 73) and  abs(player_x - clyde_x) < 30) :
        ghost_down = 1
    
    
    if ghost_right or not next_allowed[0]:
        count += 0.25
    if ghost_left or not next_allowed[1]:
        count += 0.25
    if ghost_up or not next_allowed[2]:
        count += 0.25
    ...
    # print(q_table[obs_state][action])
    if (random() < epsilon):
    ...
    if episode % 2 == 0:
        ...
        np.save('sarsa_epsiolon.npy',epsilon)
    if episode == 20: 
        run = False
    pygame.display.flip()
